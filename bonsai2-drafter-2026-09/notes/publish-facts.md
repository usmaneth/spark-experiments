...
- Fix: branch `fix/dflash-borrowed-hadamard` in `/home/usman/llama.cpp-upstream` (+48/-20; `dflash-borrowed-hadamard.patch`); restores 148/284, 137/319, 143/289 bit for bit. PR title: "dflash: apply the target's Hadamard transforms to borrowed token_embd and output". Report: `/home/usman/llama.cpp-upstream/REPRO-bonsai2-drafter.md`.
...
## Verified numbers (clean spark2, base 29.8-29.9 flat at 64/1024/2000 tokens)
...
- No `/home/usman` paths in repo files. ASCII only in scripts. No agent/workflow/model references. No Co-Authored-By. Titles in the repo's short scoped style; bodies open with "## Summary".
