#!/usr/bin/env bash
V2=/home/usman/Bonsai-demo/dflash-training/v2; MD=/home/usman/Bonsai-demo/models/bonsai2-dspark; ROOT=/home/usman/Bonsai-demo; ALL=$V2/feats_all; TAG=full2
...
sudo docker run --rm --gpus all -v /home/usman:/home/usman bonsai/dflash-trainer:latest python3 -u $V2/train_dspark_v2.py \
