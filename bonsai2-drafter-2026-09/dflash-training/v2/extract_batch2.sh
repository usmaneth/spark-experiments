#!/usr/bin/env bash
V2=/home/usman/Bonsai-demo/dflash-training/v2; cd $V2; export LD_LIBRARY_PATH=/home/usman/Bonsai-demo/bin/cuda
M=/home/usman/Bonsai-demo/models/bonsai2-gguf/27B/Ternary-Bonsai-2-27B-PQ2_0.gguf
