...
//
// Copy of extract_feats_tf.cpp with an optional 5th argument n_ctx (default 2048).
...
int main(int argc, char ** argv) {
    ...
    const int n_ctx_arg = (argc>5)?atoi(argv[5]) : 2048;
    cparams.n_ctx=n_ctx_arg; cparams.n_batch=n_ctx_arg; cparams.n_ubatch=n_ctx_arg;
    printf("n_ctx:%d (samples longer than this are skipped)\n", n_ctx_arg);
