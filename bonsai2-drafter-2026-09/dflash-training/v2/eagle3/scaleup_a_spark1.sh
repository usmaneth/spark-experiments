#!/usr/bin/env bash
# EAGLE-3 scale-up run A on spark1: waits for the half-A BON3 extraction, then trains on
...
say "launch scale-up A (spark1)"
sudo docker run --rm --gpus all --ipc=host --name eagle3_scaleA -v /home/usman:/home/usman bonsai/dflash-trainer:latest \
