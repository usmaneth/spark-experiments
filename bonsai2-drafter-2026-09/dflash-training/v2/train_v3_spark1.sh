#!/usr/bin/env bash
# spark1: DSpark v3 = the step-600 (v2) weights trained one epoch on feats_all + the 20k broad2
...
set -u
ROOT=/home/usman/Bonsai-demo; V2=$ROOT/dflash-training/v2; MD=$ROOT/models/bonsai2-dspark; LOG=$V2/logs/dspark_v3.log
...
cd $ROOT && sudo docker run --rm --gpus all --ipc=host --name dspark_v3 -v /home/usman:/home/usman bonsai/dflash-trainer:latest \
